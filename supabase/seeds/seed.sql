...
INSERT INTO "public"."custom_job_question_submission_feedback" ("id", "created_at", "submission_id", "feedback_role", "pros", "cons", "confidence_score") VALUES
	('11111111-1111-1111-1111-111111111111', NOW(), '11111111-1111-1111-1111-111111111111', 'ai', ARRAY['lorem ipsum new table', 'lorem ipsum'], ARRAY['lorem ipsum', 'lorem ipsum'], 0),
	('22222222-2222-2222-2222-222222222222', NOW(), '22222222-2222-2222-2222-222222222222', 'ai', ARRAY['lorem ipsum new table', 'lorem ipsum'], ARRAY['lorem ipsum', 'lorem ipsum'], 0.2),
	('33333333-3333-3333-3333-333333333333', NOW(), '33333333-3333-3333-3333-333333333333', 'ai', ARRAY['lorem ipsum new table', 'lorem ipsum'], ARRAY['lorem ipsum', 'lorem ipsum'], 0.4),
	('44444444-4444-4444-4444-444444444444', NOW(), '44444444-4444-4444-4444-444444444444', 'ai', ARRAY['lorem ipsum new table', 'lorem ipsum'], ARRAY['lorem ipsum', 'lorem ipsum'], 1),
	('55555555-5555-5555-5555-555555555555', NOW(), '55555555-5555-5555-5555-555555555555', 'ai', ARRAY['lorem ipsum new table', 'lorem ipsum'], ARRAY['lorem ipsum', 'lorem ipsum'], 1),
	('66666666-6666-6666-6666-666666666666', NOW(), '66666666-6666-6666-6666-666666666666', 'ai', ARRAY['lorem ipsum new table', 'lorem ipsum'], ARRAY['lorem ipsum', 'lorem ipsum'], 1),
	('77777777-7777-7777-7777-777777777777', NOW(), '77777777-7777-7777-7777-777777777777', 'ai', ARRAY['lorem ipsum new table', 'lorem ipsum'], ARRAY['lorem ipsum', 'lorem ipsum'], 1),
	('88888888-8888-8888-8888-888888888888', NOW(), '88888888-8888-8888-8888-888888888888', 'ai', ARRAY['lorem ipsum new table', 'lorem ipsum'], ARRAY['lorem ipsum', 'lorem ipsum'], 1),
	('99999999-9999-9999-9999-999999999999', NOW(), '99999999-9999-9999-9999-999999999999', 'ai', ARRAY['lorem ipsum new table', 'lorem ipsum'], ARRAY['lorem ipsum', 'lorem ipsum'], 0.8);
