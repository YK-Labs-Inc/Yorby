...
export default async function BlogPage({
  ...
  const description = demoJob.company_name
    ? `Here are some practice interview questions + sample answers for a ${demoJob.job_title} job interview at ${demoJob.company_name}.`
    : `Here are some practice interview questions + sample answers for a ${demoJob.job_title} job interview.`;
      ...
      <header className="fixed top-0 left-0 right-0 bg-white border-b z-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            ...
            <Link href="/?utm_source=blog_header">
