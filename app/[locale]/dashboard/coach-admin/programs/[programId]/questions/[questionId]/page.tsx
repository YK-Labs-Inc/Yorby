    ...
    <div className="container mx-auto py-6">
      ...
      <div className="mb-6">
        <Button asChild variant="outline" size="sm">
          <Link href={`/dashboard/coach-admin/curriculum/${programId}`}>
      ...
      <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4 mb-8">
        ...
        <div className="flex gap-2">
          <Button asChild variant="outline">
            <Link
              href={`/dashboard/coach-admin/curriculum/${programId}/questions/${questionId}/edit`}
            >
          ...
          <Button asChild variant="destructive">
            <Link
              href={`/dashboard/coach-admin/curriculum/${programId}/questions/${questionId}/delete`}
            >
      ...
      <div className="mb-4 flex items-center justify-between">
        ...
        <Button asChild>
          <Link
            href={`/dashboard/coach-admin/curriculum/${programId}/questions/${questionId}/sample-answers`}
          >
      ...
      {sampleAnswers.length === 0 && (
        <Card>
          ...
          <CardContent>
            <Button asChild>
              <Link
                href={`/dashboard/coach-admin/curriculum/${programId}/questions/${questionId}/sample-answers?tab=add`}
              >
