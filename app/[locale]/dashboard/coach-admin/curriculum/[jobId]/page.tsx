...
async function getJobData(jobId: string, coachId: string) {
  ...
  if (jobError || !job) {
    ...
    return { job: null, questions: [], error: jobError || new Error("Job not found") };
  }
...
export default async function JobDetailPage({ params }: { params: { jobId: string } }) {
  ...
  const { job, questions, error } = await getJobData(params.jobId, coachId);
    ...
    <div className="container mx-auto py-6">
      ...
      <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4 mb-8">
        ...
        <div className="flex gap-2">
          <Button asChild variant="outline">
            <Link href={`/dashboard/coach-admin/curriculum/${params.jobId}/edit`}>
              <Pencil className="h-4 w-4 mr-2" />
              Edit Job
            </Link>
          </Button>
          <Button asChild variant="destructive">
            <Link href={`/dashboard/coach-admin/curriculum/${params.jobId}/delete`}>
      ...
      <Card className="mb-8">
        <CardHeader>
          ...
          <CardDescription>
            Information about this job profile in your curriculum
          </CardDescription>
        </CardHeader>
        <CardContent>
          <div className="space-y-4">
            ...
            {job.company_description && (
              <div>
                ...
                <p className="mt-1 whitespace-pre-wrap">{job.company_description}</p>
              </div>
            )}
            
            <div className="flex items-center gap-2">
              <span className="text-sm font-medium">Status:</span>
              <Badge variant={job.status === "unlocked" ? "outline" : "secondary"}>
      ...
      <div className="mb-4 flex items-center justify-between">
        <h2 className="text-2xl font-semibold tracking-tight">Interview Questions</h2>
        <Button asChild>
          <Link href={`/dashboard/coach-admin/curriculum/${params.jobId}/questions/new`}>
      ...
      {questions.length === 0 && (
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Add interview questions to help your students prepare for this job.
            </CardDescription>
          </CardHeader>
          <CardContent>
            <Button asChild>
                ...
                {questions.map((question) => (
                  <TableRow key={question.id}>
                    <TableCell className="font-medium">
                      <Link 
                        href={`/dashboard/coach-admin/curriculum/${params.jobId}/questions/${question.id}`}
                    ...
                    <TableCell>
                      <Badge variant="outline">
                        {question.question_type === "ai_generated" ? "AI Generated" : "Manual"}
                      </Badge>
                    </TableCell>
                    <TableCell>{question.custom_job_question_sample_answers.count}</TableCell>
                    <TableCell>
                      ...
                      <DropdownMenu>
                        ...
                        <DropdownMenuContent align="end">
                          <DropdownMenuItem asChild>
                            <Link href={`/dashboard/coach-admin/curriculum/${params.jobId}/questions/${question.id}`}>
                              <Eye className="h-4 w-4 mr-2" />
                              View Details
                            </Link>
                          </DropdownMenuItem>
                          <DropdownMenuItem asChild>
                            <Link href={`/dashboard/coach-admin/curriculum/${params.jobId}/questions/${question.id}/edit`}>
                              <Pencil className="h-4 w-4 mr-2" />
                              Edit Question
                            </Link>
                          </DropdownMenuItem>
                          <DropdownMenuItem asChild>
                            <Link href={`/dashboard/coach-admin/curriculum/${params.jobId}/questions/${question.id}/sample-answers`}>
                          ...
                          <DropdownMenuItem 
                            ...
                            asChild
                          >
                            <Link href={`/dashboard/coach-admin/curriculum/${params.jobId}/questions/${question.id}/delete`}>
                              <Trash2 className="h-4 w-4 mr-2" />
                              Delete Question
                            </Link>
                          </DropdownMenuItem>
      ...
      {questions.length > 0 && (
        <div className="mt-8">
          <h2 className="text-2xl font-semibold tracking-tight mb-4">Question Details</h2>
                    ...
                    <div className="flex items-center justify-between">
                      <div className="flex items-center gap-2">
                        ...
                        <Badge variant="secondary">
                          {question.custom_job_question_sample_answers.count}
                        </Badge>
                      </div>
