...
import { updateSampleAnswer } from "../../../../actions";
import {
  Breadcrumb,
  BreadcrumbItem,
  BreadcrumbLink,
...
import { ChevronRight, Home, BookOpen, Briefcase, MessageSquare, FileText, Pencil } from "lucide-react";
...
export default async function EditSampleAnswerPage({ 
  ...
  const sampleAnswer = await getSampleAnswerDetails(params.answerId, params.questionId);
  
  if (!sampleAnswer) {
    // Sample answer not found or doesn't belong to this question
    return redirect(`/dashboard/coach-admin/curriculum/${params.jobId}/questions/${params.questionId}/sample-answers`);
  }
    ...
    <div className="container mx-auto py-6">
      ...
      <Breadcrumb className="mb-6">
        <BreadcrumbList>
          ...
          <BreadcrumbItem>
            <BreadcrumbLink href={`/dashboard/coach-admin/curriculum/${params.jobId}/questions/${params.questionId}/sample-answers`}>
      ...
      <div className="mb-8">
        <h1 className="text-3xl font-bold tracking-tight">Edit Sample Answer</h1>
        <p className="text-muted-foreground mt-2">
          Update this sample answer for the question: "{question.question.length > 100 
